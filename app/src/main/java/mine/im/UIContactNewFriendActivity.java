...
/**
 * Created by Administrator on 2020/9/23 10:25.
 */
public class UIContactNewFriendActivity extends AppCompatActivity {
    ...
    public void start(View view) {
        ...
        V2TIMManager.getFriendshipManager()
            ...
            public void onSuccess(V2TIMFriendApplicationResult v2TIMFriendApplicationResult) {
                ...
                System.out.println("v2TIMFriendApplicationResult is " + v2TIMFriendApplicationResult);

                System.out.println(v2TIMFriendApplicationResult.getFriendApplicationList());
